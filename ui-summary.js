...
class SummaryUI {
    ...
    render() {
        ...
        const scrollContainer = container.querySelector('.summary-container');
        const scrollTop = scrollContainer ? scrollContainer.scrollTop : 0;
        const stats = store.getStats();
        const kindCounts = store.getKindCounts();
        const allEvents = store.getAllEvents();
        // Get sample events for each kind
        const samplesByKind = new Map();
    ...
    `;
        ...
        const newScrollContainer = container.querySelector('.summary-container');
